...
**Coordinates**
- *Global Coordinate System*: **X**<sub>global</sub> = [X, Y, Z] with θ about Z
**General Definitions**
...
- *θ̇ (Angular Velocity)* — the angular velocity of the car relative to the neutral axis (θ = 0)
**Initial Conditions (ICs)**
- *Horizontal Alignment*: x(0) = 0 mm
- *No Horizontal Velocity*: ẋ(0) = 0 mm/s
- *Pre-Set Angular Displacement*: θ(0) = 0.5°
- *No Angular Velocity*: θ̇(0) = 0°/s
**Relevant Forces**
...
- *Normal Force*: F<sub>Normal</sub> = -m·g
**Visual Diagram**
